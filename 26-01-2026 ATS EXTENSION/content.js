...
// ============ WORKDAY AUTOMATION STATE ============
  ...
  async function autoTailorDocuments() {
    ...
    const OVERALL_TIMEOUT_MS = 150_000; // Increased from 90s to 150s to accommodate longer AI responses
    ...
    try {
      ...
      const tailorRes = await fetchWithTimeout(
        ...
        120_000, // Increased from 60s to 120s for AI tailoring (Kimi/OpenAI can take 90s+)
        'tailor_application'
      );
