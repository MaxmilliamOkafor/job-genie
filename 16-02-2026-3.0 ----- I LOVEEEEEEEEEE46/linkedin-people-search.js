...
(function (global) {
  ...
  const TARGETS = {
    ...
    devops: T(TECH_RECRUITERS.concat(['Infrastructure Recruiter']),
    ...
    security: T(TECH_RECRUITERS.concat(['Security Recruiter', 'Cyber Security Recruiter']),
    ...
    ml: T(TECH_RECRUITERS.concat(['Data Recruiter', 'AI Recruiter']),
      ...
      ['Senior Machine Learning Engineer', 'Staff ML Engineer', 'Principal Data Scientist',
       'Research Engineer']),
    'data-science': T(TECH_RECRUITERS.concat(['Data Recruiter']),
    ...
    'data-eng': T(TECH_RECRUITERS.concat(['Data Recruiter']),
    ...
    analytics: T(TECH_RECRUITERS.concat(['Data Recruiter']),
    ...
    embedded: T(TECH_RECRUITERS.concat(['Hardware Recruiter']),
    ...
    games: T(TECH_RECRUITERS.concat(['Games Recruiter']),
    ...
    erp: T(TECH_RECRUITERS.concat(['ERP Recruiter']),
    ...
    solutions: T(TECH_RECRUITERS.concat(['Sales Recruiter']),
    ...
    delivery: T(TECH_RECRUITERS.concat(['Corporate Recruiter']),
